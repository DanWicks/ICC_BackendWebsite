     ...
     <div>
        <ul class="w3-navbar w3-red">
            ...
            <div class="w3-dropdown-content w3-red">
                <a href="./admin-dashboard.php">Admin Home</a>
                <a href="./admin-staff.php">Maintain Staff</a>
                <a href="./admin-schedule.php">Maintain Schedule</a>
                <a href="./admin-availibilty.php">Staff Availibility</a>
